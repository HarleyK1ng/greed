...
conversation_rate = "Пожалуйста, оценить нас, выбрав одну из оценок на клавиатуре:"

conversation_rate_notes = "Пожалуйста, оставьте комментарий или нажмите <i>Пропустить</i>"

menu_rate_5 = "⭐️⭐️⭐️⭐️⭐️"
